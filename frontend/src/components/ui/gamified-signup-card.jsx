...
export default function GamifiedSignupCard({
  username,
  password,
  email,
  message,
  ...
  const handleSignup = () => {
    if (!username || !password || !email || loading) return;
    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white">
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-zinc-500">관리자 계정 회원가입</p>
        </div>

        <div className="mt-2 flex flex-col gap-4">
          <div>
            <Label htmlFor="signup-username" className="text-black">
              아이디
            </Label>
            <Input
              id="signup-username"
          ...
          <div>
            ...
            <Input
              ...
              className="mt-1 border-zinc-300 bg-white text-black transition-transform duration-200 hover:scale-[1.02]"
            />
            <p className="mt-1.5 text-xs text-zinc-500">8~12자, 대/소문자, 숫자, 특수문자 포함</p>
          </div>
          <div>
